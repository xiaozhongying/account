...
body {background-color:#fff;font-family:tahoma,arial,"Microsoft YaHei","\5B8B\4F53",sans-serif;color:#003c7b;font-size:16px;line-height:120%;}
...
.title{background-color:#003c7b;color:#fff;margin:0 0 40px 0;}
.title,
.view .title{font-weight:bold;text-align:center;font-size:32px;line-height:40px;padding:38px 0px;}
.view .title{background-color:inherit;color:#003c7b;margin:0;}
.view .login{margin:0 auto;padding:0;width:360px;max-width:360px;border:#003c7b solid 0px;overflow:hidden;background-color:#fff;box-shadow:0 0 8px 0px #003c7b;}
...
.box .vbox .input:focus{border-color:#003c7b;}
.box .vbox .input::placeholder{color:#999;}
.box .vbox .nolabel{border:#d6e5ef 1px solid;border-radius:6px;margin:0 0 0 66px;}
.box .vbox .nolabel:focus{border-color:#003c7b;}
.box .vbox .code{border:#d6e5ef 1px solid;border-radius:6px;width:120px;margin:0 12px 0 0;}
.box .vbox .code:focus{border-color:#003c7b;}
.box .vbox span {border-radius:6px 0 0 6px;vertical-align:middle;height:48px;line-height:48px;background-color:#003c7b;border:#003c7b 1px solid;font-size:24px;margin:0;padding:0 20px;display:inline-block;color:#fff;}
.box .vbox img{width:120px;height:46px;border:none;cursor:pointer;vertical-align:middle;}
.box .button{background-color:#003c7b;color:#fff;width:280px;height:50px;line-height:50px;cursor:pointer;border:none;border-radius:6px;-webkit-appearance:none;}
...
.box .link a:active,
.box .link label,
.box .link b{color:#003c7b;font-size:12px;text-decoration:none;outline:none;}
...
.cp a:link,
.cp a:visited,
.cp a:active{font-size:12px;font-weight:normal;font-family:arial;color:#003c7b;text-decoration:underline;outline:none;}
</style>
<style type="text/css">
...
<body>
<div class="bg"></div>
<div class="title">&nbsp;舞龙村冼培高财务管理系统</div>
<div class="view">
...
<%-- 	<div class="box"><div class="vbox link">
  ...
  <input type="hidden" name="loginURL" value="/account/account/login.jsp" />
  </form>
</div>
<div class="cp">
	&copy;  舞龙村冼培高财务管理系统
